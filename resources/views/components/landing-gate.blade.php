<div id="landing-gate" class="fixed inset-0 z-[100] flex flex-col justify-between bg-[#030303] p-6 md:p-12 transition-all duration-1000 ease-in-out select-none">
    ...
    <div class="flex justify-between items-center z-10 border-b border-zinc-900/40 pb-4">
        ...
        <span class="font-mono text-[10px] md:text-xs tracking-[0.2em] text-zinc-500">ARCHIVE // 2026</span>
    </div>

    <div class="max-w-4xl mx-auto text-center my-auto z-10 flex flex-col items-center">
        
        <div class="mb-6 relative group">
            <div class="absolute -inset-4 rounded-full bg-emerald-500/10 blur-2xl opacity-40 group-hover:opacity-80 transition duration-700"></div>
            
            <div class="relative bg-white/[0.03] border border-white/10 p-2.5 rounded-[2rem] backdrop-blur-md shadow-2xl transition-all duration-500 group-hover:border-emerald-500/30">
                <img src="{{ asset('images/logo.png') }}" alt="Logo Lintas Waktu" class="w-20 h-20 md:w-24 md:h-24 object-contain rounded-2xl transition-transform duration-500 group-hover:scale-105">
            </div>
        </div>
        ...
        <h1 class="text-5xl md:text-8xl font-black tracking-tighter text-zinc-100 uppercase bg-clip-text bg-gradient-to-b from-zinc-100 to-zinc-400">
            LINTAS WAKTU<span class="text-emerald-500 font-light">.</span>
        </h1>
